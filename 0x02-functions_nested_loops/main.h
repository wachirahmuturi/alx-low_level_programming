...
/**
 * void times_table - print multiplication table
 */
...
/**
 * void print_to_98 - print numbers n to 98
 * @n: integer argument
 */
...
/**
 * void print_times_table - print multiplication table up to n
 * @n: integer argument
 */
...
/**
  * int multiples_3_or_5 - print all the multiples of 3 or 5
